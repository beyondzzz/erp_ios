...
@interface SelectOrderViewController () <UITableViewDataSource, UITableViewDelegate>
...
- (void)createTableView {
    if (!_tableView) {
        ...
        [_tableView registerNib:[UINib nibWithNibName:@"SelectOrderTableViewCell" bundle:nil] forCellReuseIdentifier:@"SelectOrderTableViewCell"];
