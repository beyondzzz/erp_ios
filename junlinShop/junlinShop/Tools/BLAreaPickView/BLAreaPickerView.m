...
- (UIButton *)cancelButton{
    if (!_cancelButton) {
        ...
        [_cancelButton setTitleColor:kBackGreenColor forState:UIControlStateNormal];
...
- (UIButton *)sureButton{
    if (!_sureButton) {
        ...
        [_sureButton setTitleColor:kBackGreenColor forState:UIControlStateNormal];
...
- (void)sureButtonClicked:(UIButton *)sender{
    ...
    NSDictionary *proDic = _areaArray[_provinceSelectedRow];
    NSDictionary *cityDic = [[proDic objectForKey:@"citylist"] objectAtIndex:_citySelectedRow];
    NSDictionary *areaDic = [[cityDic objectForKey:@"arealist"] objectAtIndex:_areaSelectedRow];
    ...
    if (self.pickViewDelegate &&
        [self.pickViewDelegate respondsToSelector:@selector(bl_selectedAddressIDWithProvince:city:area:)]) {
        [self.pickViewDelegate bl_selectedAddressIDWithProvince:[proDic objectForKey:@"id"] city:[cityDic objectForKey:@"id"] area:[areaDic objectForKey:@"id"]];
    }
